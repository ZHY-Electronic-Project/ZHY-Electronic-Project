        ...
        %>
          ...
          <tr>
              ...
              <td>
                   ...
                   <button class="btn btn-primary" data-toggle="modal" data-target="#updateUser">修改 </button></a>
              </td>      
          </tr>
           <%
          }
		         ...
		         <form action="../UserInfoServlet?type=add" method="post" class="form-horizontal" role="form">
		          <div class="modal-header">
		           ...
		           <div class="modal-footer">
		             <input type="submit" class="btn btn-primary" value ="注册用户" href="AdminMain,jsp"onClick="return check();">
		           </div>
		           </div>         
		     </form>  
		     </div> 
