          ...
          <div class="col-md-2 col-sm-3">
            ...
            <ul id="myTab" class="nav nav-pills nav-stacked">
              <li class="active">
                <a href="#header" data-toggle="tab">
                  <i class="glyphicon glyphicon-align-justify"></i>&nbsp; 名称：新风机室</a>
              </li>
              <li><a href="#tag-1" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>模式</a>
              </li>             
              <li><a href="#tag-2" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>新风机组</a>
              </li>
            ...
            <div id="myTabContent" class="tab-content">
              ...
              <div class="tab-pane fade" id="tag-1">
                <div class="alert alert-info">
                  <h4 class="text-center">新风机模式巡检</h4>
               </div>
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-1-1" data-toggle="pill" contenteditable="false">模式</a></li>
                </ul>
               <div class="tab-content">
                <div class="tab-pane fade in active" id="panel-1-1">
                  ...
                  <div class="jumbotron well">
                    <p> 结果：</p>
                    <p>
                       <a class="btn btn-primary btn-success" href="#">自动</a>
                       <a class="btn btn-primary btn-danger" href="#">制热</a>
                       <a class="btn btn-primary btn-danger" href="#">制冷</a>
                    </p> 
              ...
              <div class="tab-pane fade" id="tag-2">
                <div class="alert alert-info">
                  <h4 class="text-center">新风机组巡检</h4>
               </div>
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-2-1" data-toggle="pill" contenteditable="false">新风机组</a></li>
                </ul>
               <div class="tab-content">
                <div class="tab-pane fade in active" id="panel-2-1">
                  <div class="jumbotron well">
                    <p>无异响/震动过大、无异味、风管无脱落/破损</p>
                  </div>
                  <div class="jumbotron well">
                    <p> 标准：无</p>
                  </div>
              ...
              <div class="tab-pane fade" id="tag-3">
                <div class="alert alert-info">
                  <h4 class="text-center">新风机室环境</h4>
               </div>
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-3-1" data-toggle="pill" contenteditable="false">环境</a></li>
                </ul>
               <div class="tab-content">
