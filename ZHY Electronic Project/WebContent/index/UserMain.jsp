...
<head>
	...
	<!-- 顶部菜单（来自bootstrap官方Demon）==================================== -->
      		...
      		<div class="container">
        		<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" >
	          		...
	          		<a class="navbar-brand" href="UserMain.jsp">用户系统</a>
        		</div>
        ...
        <form name="editForm">
                        ...
                        <div class="form-group">
                            <label for="message-text">Phone Number：</label>
                            <input type='phone' id="phone1" name="phone1" class="form-control" required placeholder="新phone number">
                            <div style="display: inline" id="tip4"></div>
                        </div>
                        <div class="form-group">
                            <label for="message-text">emial：</label>
                            <input type='email' id="email1" name="email1" class="form-control" required placeholder="请输入新的Email地址">
                            <div style="display: inline" id="tip5"></div>
                        </div>
                        <div class="form-group">
                            <label for="message-text">Site：</label>
                            <input type='site' id="site1" name="site1" class="form-control" required placeholder="请输入新site">
                            <div style="display: inline" id="tip6"></div>
                        </div>
                    </form>
        </div>
				...
				<div class="col-sm-3 col-md-2 sidebar">		
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="#userMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
							<i class="fa fa-user"></i>&nbsp; 巡检 <span class="sr-only">(current)</span></a>
						</li> 
						<ul id="userMeun" class="nav nav-list collapse menu-second">
							<li><a href="###" onclick="showAtRight('UDxunjian.jsp')"><i class="fa fa-users"></i>日巡检</a></li>
							<li><a href="###" onclick="showAtRight('UWxunjian.jsp')"><i class="fa fa-users"></i>周巡检</a></li>
							<li><a href="###" onclick="showAtRight('UMxunjian.jsp')"><i class="fa fa-users"></i>月巡检</a></li>
						</ul> 
						 
						<li><a href="#productMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
							<i class="fa fa-globe"></i>&nbsp; SOP <span class="sr-only">(current)</span></a>
						</li> 
						<ul id="productMeun" class="nav nav-list collapse menu-second">
							<li><a href="###" onclick="showAtRight('SOPaction.jsp')"><i class="fa fa-list-alt"></i>SOP</a></li>
						</ul>
...
<!-- 右侧内容展示==================================================   -->   		
 				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;<strong>&nbsp;&nbsp;&nbsp;ZHY电子化巡检系统</strong></h1>
						...
						<!-- 载入左侧菜单指向的jsp（或html等）页面内容 -->
          				...
          				<br>
          				<br>
       						<h2><strong>ZHY巡检与SOP线上平台</strong></h2>
       						<div class="panel panel-primary">
       						<div class="panel-heading">
       						<h2 class="panel-title"></h2>
       						</div>
       						<div class="panel-body">
       						<h3><strong>请严格遵循巡检以及SOP要求，佩顿好PPE!!!</strong></h3>
       						</div>
       						</div>
          				</div>  
          		</div> 
