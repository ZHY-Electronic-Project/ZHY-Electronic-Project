          ...
          <div class="col-md-2 col-sm-3">
            ...
            <ul id="myTab" class="nav nav-pills nav-stacked">
              <li class="active">
                <a href="#header" data-toggle="tab">
                  <i class="glyphicon glyphicon-align-justify"></i>&nbsp; 名称：运维配电室</a>
              </li>
              <li><a href="#tag-1" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>低压配电柜</a>
              </li>             
              <li><a href="#tag-2" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>A-UPS1</a>
              </li>
              <li><a href="#tag-3" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>A-UPS1电池</a>
              </li>
              <li><a href="#tag-4" data-toggle="tab">
                <i class="glyphicon glyphicon-tag"></i>空调</a>
              </li>
            ...
            <div id="myTabContent" class="tab-content">
              ...
              <div class="tab-pane fade" id="tag-1">
                <div class="alert alert-info">
                  <h4 class="text-center">运维配电室巡检</h4>
               </div>
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-1-1" data-toggle="pill" contenteditable="false">二级目录</a></li>
                </ul>
              ...
              <div class="tab-pane fade" id="tag-2">
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-2-1" data-toggle="pill" contenteditable="false">二级目录</a></li>
                </ul>
               <div class="tab-content">
               ...
               <div class="tab-pane fade" id="tag-3">
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-3-1" data-toggle="pill" contenteditable="false">二级目录</a></li>
                </ul>
               <div class="tab-content">
               ...
               <div class="tab-pane fade" id="tag-4">
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-4-1" data-toggle="pill" contenteditable="false">二级目录</a></li>
                </ul>
               <div class="tab-content">
               ...
               <div class="tab-pane fade" id="tag-5">
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#panel-5-1" data-toggle="pill" contenteditable="false">二级目录</a></li>
                </ul>
               <div class="tab-content">
